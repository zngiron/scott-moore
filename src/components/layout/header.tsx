...
const darkBackgroundSections = ['about', 'career', 'contact'];
  ...
  return (
    <header
      className={cn(
        ...
        'safe-top',
        isDarkBackground ? 'bg-black/50 text-white' : 'bg-white/50 text-foreground dark:bg-background/50',
      )}
    >
      <div className={cn('mx-auto w-full max-w-screen-2xl', 'flex items-center justify-between px-6 py-4', 'lg:px-36')}>
        <Link
          href="/#hero"
