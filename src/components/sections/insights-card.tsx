...
import { containerVariantsFast, easeOut, hoverTransition, itemVariantsSubtle } from '@/lib/motion';
import { cn } from '@/lib/utils';

import { insightArticles } from '@/data/static/insights';
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2">
        ...
        <h3 className="font-display text-xl font-light leading-7 text-foreground">{article.title}</h3>
        <p className="line-clamp-2 text-sm leading-5 text-muted-foreground">{article.description}</p>
      </div>
