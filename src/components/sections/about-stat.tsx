...
function AnimatedStat({ value, label, prefix = '', suffix = '' }: StatProps) {
  ...
  return (
    ...
    >
      <motion.p
        className={cn('font-display text-4xl font-light leading-tight tracking-tight', 'md:text-5xl')}
        initial={{
          opacity: 0,
          y: 20,
        }}
  ...
  return (
    ...
    >
      <div className="ml-auto">
        ...
        <motion.h2
          className={cn('mb-6', 'font-display text-4xl font-light leading-tight tracking-tight', 'md:text-6xl')}
          variants={itemVariants}
        >
        ...
        <motion.p
          ...
          variants={itemVariants}
        >
          A finance executive driven by strategy and results. Focused on turning complex financial goals into clear,
          achievable outcomes through insight, discipline, and a forward-looking mindset
        </motion.p>
