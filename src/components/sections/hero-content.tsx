    ...
    <>
      ...
      >
        <div className="max-w-xl">
          ...
          <motion.h1
            className={cn('mb-8', 'font-display text-7xl font-light leading-none tracking-tighter', 'md:text-9xl')}
            variants={itemVariantsSlow}
          >
          ...
          <motion.p
            ...
            variants={itemVariantsSlow}
          >
            Experienced finance executive helping individuals and businesses navigate investments, risk, and global
            financial strategy.
          </motion.p>
          ...
          <motion.div variants={itemVariantsSlow}>
            <Button
              ...
              size="lg"
              className={cn(
                'bg-black/80 text-white hover:bg-black/90 backdrop-blur-xl',
